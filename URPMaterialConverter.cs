...
namespace UnityEditor.UnityFixes
{
    ...
    {
        [MenuItem("Edit/Universal Render Pipeline/Upgrade Project Materials to UniversalRP Materials")]
        ...
        [MenuItem("Edit/Universal Render Pipeline/Upgrade Selected Materials to UniversalRP Materials")]
        ...
        [MenuItem("Edit/Universal Render Pipeline/Upgrade Materials From Selected Folder to UniversalRP Materials")]
